...
export const POSTER_BIG_URL = 'http://image.tmdb.org/t/p/w300';
export const RELATED_MOVIES = (id,key) =>`https://api.themoviedb.org/3/movie/${id}/similar?api_key=${key}`;
export const HOLLYWOOD_NEWS = 'https://newsapi.org/v2/everything?language=en&q=hollywood&from=2018-11-17&sortBy=publishedAt&apiKey=';